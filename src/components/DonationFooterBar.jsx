        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-sm-12 col-xs-12 col-md-4 col-lg-4 text-center py-md-5">
              <button className="border-primary bg-primary rounded px-4 text-light fs-5 py-2" onClick={()=> handleRoute('donations/upcomings')}>Upcoming Course</button>
            </div>
          </div>
        </div>
...
export default DonationFooterBar;