...
const DonationBlock = (props) => {
  ...
  return (
    <>
      <Row>
        <Col lg={{ span: 1, order: 1 }} sm={{ span: 12, order: 1 }}>
          <span style={{ fontSize: 40 }}>7</span><br />
          <span>Decemver</span>
        </Col>
        <Col lg={{ span: 6, order: 3 }} sm={{ span: 12, order: 2 }} className="mb-3">
          <img className="rounded-2" style={{ width: '100%' }} src={image} />
        </Col>
        <Col lg={{ span: 5, order: 2 }} sm={{ span: 12, order: 3 }} className="mb-3">
