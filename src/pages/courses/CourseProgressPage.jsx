  ...
  return (
    <>
      <div className="container mb-5">
        ...
        <div className="row">
          <div className="col-sm-12 col-xs-12 col-md-3 col-lg-3 d-flex flex-column justify-content-center">
            <CourseLessonItem title='Unit1' description="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknow printer took a galley of type and"  />
          </div>  
          <div className="col-sm-12 col-xs-12 col-md-3 col-lg-3 d-flex flex-column justify-content-center">
            <CourseLessonItem title='Unit2' description="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknow printer took a galley of type and" />
          </div>
          <div className="col-sm-12 col-xs-12 col-md-3 col-lg-3 d-flex flex-column justify-content-center">
