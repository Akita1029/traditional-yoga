        ...
        <div className="menu-list text-light d-flex justify-content-center align-items-center">
          {isDesktopOrLaptop && (
            <>
              ...
              <li><a rel="noreferrer" href="https://vedicnutraceuticalsusa.com/" target="_blank" className="text-light text-decoration-none active:text-light active:text-decoration-none">Shop</a></li>
