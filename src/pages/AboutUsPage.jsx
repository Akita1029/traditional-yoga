  ...
  return(
    ...
    <div className="p-6 pt-4">
      <div className="d-flex flex-row justify-content-between align-items-center">
        ...
        <div className="w-50 ps-6 pe-3 d-flex flex-column justiy-content-start">
      ...
      <div className="d-flex flex-row justify-content-between align-items-center mt-5">
        ...
        <div className="w-50 ps-3 pe-3 d-flex flex-column justiy-content-start">
      ...
      <div className="w-50 ps-3">
        ...
        <div className="w-50 ps-6 d-flex flex-column justiy-content-start">
      ...
      <div className="d-flex flex-column mt-5 ps-3 pe-3">
        <h3 className="text-primary fw-bold">Dr.Kumar</h3>
        <img className="w-100 mt-3" src={require('../assets/images/dr.kumar.png')} />
        <h3 className="fw-bold text-primary mt-3 mb-3">"You only teach what you practice and practice what you teact".</h3>
